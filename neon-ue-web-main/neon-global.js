// Define the NEON API
namespace NEON {
  function invokeUnrealEvent(delegate: string, data: object = {}) {
    return NEON_Bridge_Unreal.invokeUnrealEvent(delegate, data);
  }
  const invokeUnreal = invokeUnrealEvent;
  ...
  function onInvoke(delegate: string, callback: (data: any) => void) {
    NEON_Bridge_Web.registerCallback(delegate, callback);
  }

  function invoke(delegate: string, data: any) {
